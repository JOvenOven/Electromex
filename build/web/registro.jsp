            ...
            <div id="inises">
                <form method="get" action="validarregistro"> 
                    <div class="field-wrap">
                        ...
                        <input type="text" id="usu" value="" onKeyPress="return validarn(event)"required onpaste="return false" name="usu">
                    </div>
                    <div class="field-wrap">
                        <label>
                            Contraseña<span class="req">*</span>
                        </label>
                        <input type="password" id="contra" value="" name="contra">
                    </div>
                    <div class="field-wrap">
                        <label>
                            Confirmar Contraseña<span class="req">*</span>
                        </label>
                        <input type="password" id="confirmarcontra" value="" name="confirmarcontra">
                    </div>
