<%-- 
    Document   : userwin
    Created on : 8/04/2019, 07:20:18 PM
    Author     : Profesor
--%>
...
<head>
    ...
    <title>Bienvenido a ElectroMex</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="CSS/userwin.css" />
    <script src="JS/userwinv.js"></script>
</head>
<body>
    ...
    <h1 id="bienvenido"><center>Bienvenido a ElectroMex</center></h1>
</body>
</html>