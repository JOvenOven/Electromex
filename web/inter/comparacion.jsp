<%-- 
    ...
    Created on : 8/04/2019, 07:17:50 PM
    Author     : Profesor
--%>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="CSS/comparacion.css" />
    <script src="JS/comparacionv.js"></script>
</head>
<body>
        <table id="cinta" width=100%>
            ...
            <br>
            <header id="encabezadocomparacion"><center>Comparaciones</center></header>
</body>
</html>
