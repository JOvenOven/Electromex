...
@WebServlet(name = "regequiposser", urlPatterns = {"/regequiposser"})
public class regequiposser extends HttpServlet {
...
boolean flag = true;
//Validaciones
		if(request.getParameter("selequipo") != null){
			equi = request.getParameter("selequipo");
		}
